...
export default {
  ...
  methods: {
    ...
    socialLogin(social){
      if(social=='kakao'){
        ...
        console.log('네이버 로그인')
         var url = 'https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=hxdc_g1LansbUuI5iyix&redirect_uri=http://localhost:8080/login&state=1234';
  ...
  mounted(){
    ...
    if(this.$route.query.code!=undefined){
      ...
      axios
          .get("https://nid.naver.com/oauth2.0/token?grant_type=authorization_code&client_id=hxdc_g1LansbUuI5iyix&client_secret=LKgEmvXPLw&code="+this.$route.query.code+"&state="+this.$route.query.state)
          .then(res => {
